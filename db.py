...
class LowercaseDB(DB):
  ...
  def items(self):                     return super(LowercaseDB, self).items()
  def iteritems(self):                 return super(LowercaseDB, self).iteritems()
  def __iter__(self):                  return super(LowercaseDB, self).__iter__()
