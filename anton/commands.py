...
`_regex_matcher`, `_command_matcher` or `all`.
"""
...
def _command_matcher(trigger_strings, *args):
    """
    ...
    parameters.
    """
    if isinstance(command_strings, basestring):
    ...
    def decorate(handler):
        ...
        if len(args) == 0:
            args2 = handler.func_code.co_argcount - 1
        else:
            args2 = args
